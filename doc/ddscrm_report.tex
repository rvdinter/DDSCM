...
\title{Simulation of Perishable Products}
...
Retailers that sell perishable products should manage their supply chain in order to have the least amount or waste or
shortages as possible. A retailer in barbecue products was selected for this assignment. This retailer recorded its
demand data for the years 2014 to 2017. An attempt to improve demand prediction was sought after using machine learning
models, weather data from KNMI and demand data. This attempt was compared against a simulation model using a mean
average of the preceding weekdays.
...
In order to predict forecast demand, several prediction models were created. These models included:
